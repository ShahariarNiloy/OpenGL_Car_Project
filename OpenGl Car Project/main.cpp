...
void displayBIGBox(float boxLength, float boxWidth, float boxHeight) // length -> x axis, width -> yaxis, height -> z axis
{
    ...
    glBegin(GL_QUADS);
    {
        glColor3f(0.2, 0, 0.2);//front and back surface of car
        ...
        glColor3f(0.4, 0, 0.4);//side surface of car
        ...
        glColor3f(0.4, 0.4, 1);//upper and lower surface of car
...
void displaySMALLBox(float boxLength, float boxWidth, float boxHeight) // length -> x axis, width -> yaxis, height -> z axis
{
    ...
    glBegin(GL_QUADS);
    {
        glColor3f(0.4, 0.4, 1);//front side of car
        glVertex3f( halfBoxWidth*3,halfBoxLength, halfBoxHeight);
        glColor3f(0.6, 0.6, 1);
        glVertex3f( halfBoxWidth*3,-halfBoxLength, halfBoxHeight);
        glColor3f(0.87, 0.87, 0.87);
        glVertex3f( halfBoxWidth*5,-halfBoxLength, -halfBoxHeight);
        glColor3f(0.87, .87, 0.87);
        glVertex3f( halfBoxWidth*5,halfBoxLength, -halfBoxHeight);

        glColor3f(0.6, 0.6, 1);//back side of car
        glVertex3f( -halfBoxWidth*3,halfBoxLength, halfBoxHeight);
        glVertex3f( -halfBoxWidth*3,-halfBoxLength, halfBoxHeight);
        glVertex3f( -halfBoxWidth*5,-halfBoxLength, -halfBoxHeight);
        glVertex3f( -halfBoxWidth*5,halfBoxLength, -halfBoxHeight);
        ...
        glColor3f(0.69, 0.4, 1);// sides of car
        ...
        glColor3f(0.6, 0, 0.6);//up side and down side of car
...
void displayLight(float lightLength, float lightWidth, float lightHeight,float lightboxHeight, float lightstandHeight)
{
    ...
    glBegin(GL_QUADS);
    {
        glColor3f(1, 0.56, 0);//front part of the light box
...
void displayScene()
{
    ...
    float HeadlightLength = 20, HeadlightWidth = 20, HeadlightHeight = 10;
